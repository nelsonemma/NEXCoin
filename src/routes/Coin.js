...
const Coin = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Link to='/'>
        <button style={{padding:'0.2em  0.6em'}}>Back</button>
        </Link>
      </div>
        ...
        <div className='content' >
          ...
          <div className='info' >
            <div className='coin-heading' >
                  ...
                  <h4> {coin.name} </h4>
                  <p style={{fontSize: "13px"}}> {coin.symbol}/USDT </p>
            </div>
          ...
          <div className='stats' >
            ...
            <div className='row' >
              ...
              <div className='row' >
                ...
                {coin.market_data?.circulating_supply ? <p>${coin.market_data.circulating_supply.usd}</p> : null  }    
              </div>
            </div>
          </div>
        </div>
